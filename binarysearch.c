 ...
 */
 /*int recursivesize( struct bst_node* node){
 printf("start of height\n");
   //int leftheight = recursiveheight(node->left);
   //int rightheight = recursiveheight(node->right);
   int leftsize  = 0;
   int rightsize = 0;
 if (node->left){
 leftsize = recursivesize(node->left);
   }
    //return leftheight +1
if(node->right){
rightsize = recursivesize(node->right);
}
...
int bst_size(struct bst* node) {
 // int result = recursiveheight(bst->root);
 ...
 int leftsize = bst_size(node->left);
 int rightsize = bst_size(node->right);
 ...
 */
 int recursiveheight (struct bst_node * node){
 printf("start of height\n");
   //int leftheight = recursiveheight(node->left);
   //int rightheight = recursiveheight(node->right);
   int leftheight = -1;
